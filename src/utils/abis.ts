...
export const CONSENSUS_FUNCTIONS = parseAbi([
	...
	"struct SafeTransaction.T {uint256 chainId; address safe; address to; uint256 value; bytes data; uint8 operation; uint256 safeTxGas; uint256 baseGas; uint256 gasPrice; address gasToken; address refundReceiver; uint256 nonce;}",
	...
	"function proposeTransaction(SafeTransaction.T transaction) external returns (bytes32 transactionHash)",
]);